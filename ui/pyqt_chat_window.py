...
from .components.widget_progress import EnhancedProgressWidget, ProgressWidget
...
class ChatWindow(QWidget):
    ...
    def _init_Layout(self):
        ...
        self.tool_status_widget = ProgressWidget(self.chat_area)
        self.vlay.addWidget(self.tool_status_widget)
    ...
    def _init_side(self):
        ...
        self.main_splitter.setSizes(
            [
                self.sidebar_width,
                self.window_width - self.sidebar_width - self.collapsed_width - 20,
    ...
    def _init_end(self):
        ...
        chat.load_persistent_history(max_messages=config.api.max_history_rounds * 2)
