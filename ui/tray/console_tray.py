...
import subprocess
import time
from nagaagent_core.vendors.PyQt5.QtWidgets import QSystemTrayIcon, QMenu, QAction, QApplication  # 统一入口 #
from nagaagent_core.vendors.PyQt5.QtCore import QTimer, pyqtSignal, QObject  # 统一入口 #
