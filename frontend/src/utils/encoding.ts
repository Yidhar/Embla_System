...
export interface StreamChunk {
  type: 'content' | 'reasoning' | 'content_clean' | 'round_start' | 'tool_calls' | 'tool_results' | 'round_end' | 'auth_expired' | 'compress_start' | 'compress_progress' | 'compress_end' | 'compress_info'
  text?: string
  round?: number
