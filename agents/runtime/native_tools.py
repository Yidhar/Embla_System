...
_NATIVE_TOOL_DEFINITIONS: List[Dict[str, Any]] = [
    # ── native_read ───────────────────────────────────────────
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "mode": {"type": "string", "enum": ["line_range", "grep", "jsonpath", "preview"]},
    ...
    },
    {
        ...
        "description": "Read a specific AST chunk or line range from a source file.",
        "parameters": {
            "type": "object",
            "properties": {
                "path": {"type": "string"},
                "target_path": {"type": "string", "description": "optional dotted path to AST node"},
                "start_line": {"type": "integer", "minimum": 1},
                "end_line": {"type": "integer", "minimum": 1},
