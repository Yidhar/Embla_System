...
function buildEditorState(config: Record<string, unknown>): EditorState {
  ...
  return {
    ...
    defaultExecutionBackend: stringValue(sandbox.default_execution_backend, "os_sandbox"),
    selfRepoExecutionBackend: stringValue(sandbox.self_repo_execution_backend, "os_sandbox"),
    ...
    boxliteImage: stringValue(boxlite.image, "embla/boxlite-runtime:py311"),
...
function buildPatch(state: EditorState): Record<string, unknown> {
  return {
    ...
    sandbox: {
      default_execution_backend: stringValue(state.defaultExecutionBackend, "os_sandbox"),
      self_repo_execution_backend: stringValue(state.selfRepoExecutionBackend, "os_sandbox"),
      boxlite: {
        ...
        image: stringValue(state.boxliteImage, "embla/boxlite-runtime:py311"),
