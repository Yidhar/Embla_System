#!/usr/bin/env python3
"""Legacy desktop release compatibility gate for Electron + Vue frontend (WS20-006)."""
...
def build_release_compat_report(project_root: Path | None = None) -> dict:
    ...
    return {
        ...
        "gate_mode": "legacy_electron_frontend",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WS20-006 desktop release compatibility verifier (legacy gate)")
    parser.add_argument(
        "--report-out",
