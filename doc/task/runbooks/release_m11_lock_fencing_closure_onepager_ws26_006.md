...
```bash
python -m pytest -q tests/test_run_ws26_m11_runtime_chaos_suite_ws26_006.py tests/test_release_closure_chain_m11_ws26_006.py tests/test_agentic_loop_contract_and_mutex.py tests/test_chaos_lock_failover.py tests/test_chaos_sleep_watch.py tests/test_process_lineage.py tests/test_export_ws26_runtime_snapshot_ws26_002.py -p no:tmpdir
