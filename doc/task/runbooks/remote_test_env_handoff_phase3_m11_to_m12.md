...
4. `doc/task/09-execution-board.csv` 与 `doc/task/99-task-backlog.csv` 目前仍是 `WS10-WS20` 主域口径；`WS23-WS27` 进度以 `doc/task/23-phase3-full-target-task-list.md` + `doc/task/implementation/NGA-WS27-*.md` 为准。
