...
```bash
python -m pytest -q tests/test_mcp_plugin_isolation_ws24_001.py tests/test_run_plugin_isolation_chaos_suite_ws24_005.py tests/test_release_closure_chain_m9_ws24_006.py
```
