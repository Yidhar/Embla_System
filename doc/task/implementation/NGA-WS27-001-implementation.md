...
- 文件: `agents/runtime/ws27_longrun_endurance.py`
- 变更:
...
- `python3 -m pytest -q tests/test_run_ws27_longrun_endurance_ws27_001.py tests/test_run_ws27_longrun_endurance_ws27_001.py -p no:tmpdir`
