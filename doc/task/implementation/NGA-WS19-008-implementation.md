...
## 测试覆盖
- 新增 `tests/test_router_arbiter_guard_ws19_008.py`
  - 委派次数达到阈值后冻结/HITL 升级
  - 冲突 ticket 变化时计数重置
...
- `evidence_link`:
  - `autonomous/router_arbiter_guard.py; tests/test_router_arbiter_guard_ws19_008.py; autonomous/__init__.py; doc/task/implementation/NGA-WS19-008-implementation.md`
- `notes`:
