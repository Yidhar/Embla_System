...
> 2026-03-05 | v5 + 工具最小注入 / Fast-Track 安全约束 / 双通道 P2P / L2 门禁细化
...
| 触发事件 | 触发者 | 废弃范围 |
|---------|--------|---------|
| 重大重构 | Dev `report_to_parent(type="major_refactor")` | affected scope 的 L1+L2 |
...
| 工具 | 作用 |
|------|------|
| `report_to_parent` | 上报（completed/blocked/error/major_refactor）|
