...
| Global Mutex / Lock Scavenger | 🟢 WS26-004 已接入调用链自动清道夫扫描 | `system/global_mutex.py`, `system/lock_scavenger.py`, `apiserver/agentic_tool_loop.py` | `tests/test_global_mutex.py`, `tests/test_chaos_lock_failover.py`, `tests/test_agentic_loop_contract_and_mutex.py` | 仍需完成 WS26-005：double-fork/脱离进程树回收链 |
