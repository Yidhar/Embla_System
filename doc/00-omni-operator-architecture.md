...
| `register_new_tool` 隔离插件宿主 | 🟢 第二版已落地（WS24-001~004） | `mcpserver/plugin_worker.py`, `mcpserver/plugin_worker_runtime.py`, `mcpserver/plugin_manifest_policy.py`, `mcpserver/mcp_registry.py`, `mcpserver/mcp_manager.py` | `tests/test_mcp_plugin_isolation_ws24_001.py` | 仍需推进 WS24-005/006：攻击演练集与 M9 发布门禁接入 |
