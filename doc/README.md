...
1. 先读 `L0`：`doc/01-module-overview.md`、`doc/05-dev-startup-and-index.md`、`doc/04-api-protocol-proxy-guide.md`。
...
4. 涉及历史追溯时才进入 `L3`：`doc/00-mvp-architecture-design.md`、`doc/task-autonomous-skeleton.md`、`doc/task/implementation/`。
